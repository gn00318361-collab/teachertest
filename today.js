...
const fallbackRoomSchedules = {
  ...
  "7/10": {
    ...
    date: "115年7月10日（星期五）",
    method: "試教10分鐘",
    per_candidate_minutes: 20,
    rooms: [
      { room: "資優班教室一", subjects: [{ id: "0710_room_1_subject_1", time: "09:00 - 11:30", subject: "自然鐘點教師", vacancy: "1名，每週10-14節", scope: "五年級自然，單元自選", judges: ["邱俊智", "陳莉榛", "高琳茵"] }] },
      { room: "資優班教室二", subjects: [{ id: "0710_room_2_subject_1", time: "09:00 - 10:40", subject: "閩南語鐘點教師", vacancy: "1名，每週8-10節", scope: "一年級閩南語，單元自選", judges: ["高琳茵", "蘇一智", "廖人鋐"] }] },
      { room: "205教室", subjects: [{ id: "0710_room_3_subject_1", time: "09:00 - 11:30", subject: "美勞鐘點教師", vacancy: "2名，每週12-16節", scope: "四年級木作教學，單元自選", judges: ["鄭嘉琪", "吳文瓊", "陳莉榛"] }] },
      { room: "206教室", subjects: [{ id: "0710_room_4_subject_1", time: "09:00 - 10:40", subject: "體育鐘點教師", vacancy: "1名，每週10-14節", scope: "四或五年級體育，單元自選", judges: ["廖人鋐", "蘇一智", "邱俊智"] }] },
    ],
  },
};
      ...
      (room.subjects || []).forEach((subject) => {
        ...
        jobs.push(makeJob(
          ...
          subject.scope || "",
          {
            ...
            slotMinutes: subject.slot_minutes || room.slot_minutes || exam.per_candidate_minutes || (dateKey === "7/10" ? 20 : 25),
