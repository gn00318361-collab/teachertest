...
- 支援上一位、下一位與看板進度切換。
- 目前考生資料先使用 9 筆 `000` 測試名單模擬第三招缺額與四試場分流，正式姓名可再更新。
- 四試場各自獨立分流排程：
  - 全試場 09:00 齊發
  - 每位考生 10 分鐘
  - 各教室依自己的考生序列獨立排程
...
- 切換考生前會檢查是否有未送出的分數。
- 評審選擇需輸入密碼 `csps`。
- 7/10 評審名單：邱俊智、陳莉榛、廖人鋐、蘇一智、鄭嘉琪、吳文瓊、高琳茵、王郁翔。
- 7/10 第三招四試場分流設定：
  - 資優班教室 A：普通班導師與本土語，邱俊智、高琳茵
  - 205 教室：語文與局端行政組，鄭嘉琪、廖人鋐
  - 206 教室：藝能與專長科任組，吳文瓊、陳莉榛
  - 資優班教室 B：特教巡輔組，蘇一智、王郁翔
